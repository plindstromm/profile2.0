          ...
          <div className="resumeModal__column">
            <div className="resumeModal__section">
              ...
              <div>
                ...
                <p>2012 - 2022</p>
                <p>
                  A surface treatment company for steel and other metals located
                  in Jonkoping, Sweden.
                </p>
              </div>
              <div>
                ...
                <p>2023 - 2024</p>
                <p>
                  A cryptanalysis web application for your average and advanced
                  user located in St. Julian's Malta.
                </p>
              </div>
            </div>
            <div className="resumeModal__section">
              ...
              <div>
                ...
                <p>2009 - 2012</p>
                <p>
                  Completed an electrician program at Bäckadalsgymnasiet gaining
                  experience in electrical systems installation and maintenance.
                </p>
              </div>
              <div>
                ...
                <p>2022 - 2024</p>
                <p>
                  Just finished a Frontend dev program at JENSEN YH Gothenburg,
                  Sweden, acquiring expertise in web development tools such as
                  HTML, CSS, Javascript/Typescript (React), and UX/UI tools like
                  Figma.
                </p>
              </div>
            </div>
          ...
          <div className="resumeModal__column">
            <div className="resumeModal__section">
              ...
              <p>
                ...
                <a
                  href="https://github.com/plindstromm?tab=repositories"
                  target="_blank"
            ...
            <div className="resumeModal__section">
              <h3>Languages</h3>
              <p>
                Fluent in Swedish and English, enabling both local and global
                work environments.
              </p>
            </div>
            <div className="resumeModal__section">
              ...
              <ul>
                ...
                <li>
                  Electrician Work: Installation, Maintenance, and
                  Troubleshooting
                </li>
